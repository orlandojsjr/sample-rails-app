...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { inicio: @evento.inicio, local: @evento.local, nome: @evento.nome }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { inicio: @evento.inicio, local: @evento.local, nome: @evento.nome }
    assert_redirected_to evento_path(assigns(:evento))
  end
